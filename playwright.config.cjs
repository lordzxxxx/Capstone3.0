...
module.exports = defineConfig({
  ...
  webServer: {
    command:
      'flutter build web --release --dart-define=USE_FIREBASE_EMULATOR=true --dart-define=BROWSER_QA=true --output=build/web-browser && WEB_ROOT=build/web-browser node tests/browser/spa-server.cjs',
