...
class PatientHistoryDialogs {
                              ...
                              children: List.generate(history.length, (index) {
                                ...
                                final statusRaw =
                                    (record['status'] ??
                                        ...
                                        .toString()
                                        .toLowerCase();
                                final isCompleted = statusRaw.contains(
                                  'complete',
                                );
                                final rawSymptoms =
  ...
  static ButtonStyle _historyOutlinedButtonStyle() {
    return OutlinedButton.styleFrom(
      ...
      side: const BorderSide(color: _histAccent, width: 1.4),
  ...
  static Widget _buildLightEmptyState(String message) {
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Icon(Icons.inbox_rounded, color: _histMuted, size: 40),
            const SizedBox(height: 12),
            Text(
              message,
              textAlign: TextAlign.center,
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () => Navigator.of(dialogContext).pop(),
                          icon: Icon(Icons.close_rounded, color: _histAccent),
                        ),
                      ],
                    ),
                  ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(color: _histMuted, fontSize: 12.5),
                          ),
                          const SizedBox(height: 12),
  ...
  static Widget _buildEmptyState(String message) {
    return Container(
      ...
      child: Text(message, style: TextStyle(color: _histMuted, fontSize: 13)),
    );
  }
        ...
        return Container(
          ...
          child: Table(
            columnWidths: isCompact
                ...
                : const {0: FixedColumnWidth(240), 1: FlexColumnWidth()},
            defaultVerticalAlignment: TableCellVerticalAlignment.top,
            border: TableBorder(
              horizontalInside: BorderSide(color: _histBorder),
            ),
            children: entries
                .map(
                  (entry) => TableRow(
  ...
  static List<MapEntry<String, List<PatientTimelineEvent>>>
  _groupTimelineByModule(List<PatientTimelineEvent> timeline) {
